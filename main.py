...
if __name__ == '__main__':
    ...
    common = getCommon(file1_items, file2_items)
    print("----------- Common words in file1 and file2 -------------")
    print('\n'.join(common))
    
    # get words in (file1 - file2)
    file1_diff_file2 = getDiff(file1_items, file2_items)
    print('----------- Words in (file1 - file2) ------------')
    print('\n'.join(file1_diff_file2))
    
    # get words in (file2 - file1)
    file2_diff_file1 = getDiff(file2_items, file1_items)
    print('----------- Words in (file2 - file1) ------------')
    print('\n'.join(file2_diff_file1))
